...
export const createPostValidation = Joi.object({
  ...
  status: Joi.string()
    ...
    .default("available")
    .messages({
      "any.only": "Status must be one of: available, taken, pending, early, late",
    }),
  ...
  condition: Joi.string()
    ...
    .required()
    .messages({
      "any.only": "Condition must be one of: excellent, very good, good, fair, needs repair",
